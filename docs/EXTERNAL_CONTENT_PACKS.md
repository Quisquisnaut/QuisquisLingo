...
## Image Bank
Shared across courses. The starter app may include the 113-image sample bank. External banks contain image_bank_manifest.json plus the image files it lists, and nothing else (rules: `docs/IMAGE_BANK_PACKAGES.md`). Maximum image file size: 50 KB. Missing assets must be reported.
