...
Updated for Version 2.0.26, Phase 226.04, revision 0 (technical build 226040) and Course Model v6
...
Fill in the blank uses **Use ___ (3 underscores)**. A nonempty Hint appears through the shared learner and Preview renderer, both before Save and after reloading saved content. Empty Hints remain absent and correct-answer validation remains unchanged.
