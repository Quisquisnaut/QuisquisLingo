...
Updated for Version 2.0.30, Build 230, revision 0 (technical build 230) and Course Model v7
...
The current time-limited alpha expires on 2026-10-11 under the established 30-day release policy. Expiry blocks learner exercises and Review but deliberately leaves Course Manager and Course Editor available so authoring work can be inspected, recovered and exported. Expiry never deletes local data.
