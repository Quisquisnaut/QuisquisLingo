...
void main() {
  ...
  test(
    ...
    () {
      ...
      expect(AppMetadata.buildNumber, '243012');
      expect(AppMetadata.developmentPhase, '243');
      expect(AppMetadata.correctiveRevision, 12);
      expect(AppMetadata.build, '243');
      expect(AppMetadata.platformBuildNumber, '243012');
      expect(AppMetadata.technicalVersion, '2.0.43+243012');
      expect(AppMetadata.version, AppMetadata.technicalVersion);
      expect(version, AppMetadata.technicalVersion);
      expect(AppMetadata.displayLabel, 'Version 2.0.43\nBuild 243, Revision 12');
      expect(AppMetadata.publicBuildLabel, 'Build 243, Revision 12');
    },
  );
