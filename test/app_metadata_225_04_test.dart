...
void main() {
  ...
  test(
    ...
    () {
      ...
      expect(AppMetadata.releaseVersion, '2.0.51');
      expect(AppMetadata.buildNumber, '251000');
      expect(AppMetadata.developmentPhase, '251');
      expect(AppMetadata.correctiveRevision, 0);
      expect(AppMetadata.build, '251');
      expect(AppMetadata.platformBuildNumber, '251000');
      expect(AppMetadata.technicalVersion, '2.0.51+251000');
      expect(AppMetadata.version, AppMetadata.technicalVersion);
      expect(version, AppMetadata.technicalVersion);
      expect(AppMetadata.displayLabel, 'Version 2.0.51\nBuild 251, Revision 0');
      expect(AppMetadata.publicBuildLabel, 'Build 251, Revision 0');
    },
  );
