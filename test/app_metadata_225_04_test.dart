...
void main() {
  ...
  test(
    ...
    () {
      ...
      expect(AppMetadata.build, '226.02.4');
      expect(AppMetadata.platformBuildNumber, '226024');
      expect(AppMetadata.technicalVersion, '2.0.26+226024');
