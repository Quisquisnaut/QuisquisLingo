...
class _DuelFixture {
  ...
  const _DuelFixture({required this.course, required this.chapter});
}

_DuelFixture _duelFixture() {
  ...
  return _DuelFixture(course: course, chapter: chapter);
}
