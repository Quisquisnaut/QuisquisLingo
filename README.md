...
**Current source version: 2.0.45+245002 · Build 245, Revision 2 · Course Model v11 (`formatVersion: 11`).**
...
the editor keeps form and navigation state. Each architecture revision is
