...
**Current source version: 2.0.43+243001 · Build 243, Revision 1 · Course Model v11 (`formatVersion: 11`).**

**QuisquisLingo 2.0.43 Beta — QQL 243 Course Model v11**

Current project version: 2.0.43

See the [Build 243 change summary](docs/243_CHANGE_SUMMARY.md) for Course Model v11, its new optional Course fields and the clean cut from v9/v10, and the [Build 242 change summary](docs/242_CHANGE_SUMMARY.md) for the previous release. Revision 1 stops one unreadable stored Course from hiding the others. Build 243 is the first step towards the portable course package; see the [course package plan](docs/COURSE_PACKAGE_PLAN.md).
