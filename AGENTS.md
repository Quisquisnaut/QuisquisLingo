...
- `2.0.24+224` rationalizes exercises behind Select, Input, Arrange, Match and Presentation models; adds grouped authoring presets, Type the translation, contextual comprehension, deterministic answer variants and closest-correction feedback; and moves the Course Editor Lesson list and unchanged Lock control to a dedicated draft-preserving management page without changing Course Model v5, progression, XP, Review, Duel, identity or stable IDs.
