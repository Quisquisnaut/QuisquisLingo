    ...
    body: ListView(
      ...
      children: [
        ...
        _HelpSection(
          ...
          body:
              'Custom Course Editor starts locked for each course to prevent accidental changes. Unlock only the course you intend to edit. A course may be marked TEMPORARY SAMPLE while it contains development or demonstration material. View Course Info retains that description; the main Course Editor does not repeat it. Replace sample material with reviewed educational content before distribution.',
        ),
        _HelpSection(
