  ...
  Widget build(BuildContext context) => _TechnicalPage(
    ...
    sections: const [
      ...
      _HelpSection(
        ...
        body:
            'Course, Lesson, Guidebook, Round and authored Exercise content carry draft/published state. Guidebook defaults to published when its optional state is absent. Lesson, Round and Exercise also require UTC updatedAt timestamps. A Course stores Lesson numbering and fallback-icon settings plus optional managed custom Lesson-icon assets. A Lesson contains lessonId, title, optional Section and themeIconAsset metadata, guidebook, rounds[] and its Duel identity. Round title is optional and falls back everywhere to its current Round N position without changing identity.',
      ),
      _HelpSection(
