...
/// Lightweight decorative scenes for the bottom of Lesson pages.
///
...
class LessonDecoration extends StatelessWidget {
  final int variant;
  const LessonDecoration({super.key, required this.variant});
