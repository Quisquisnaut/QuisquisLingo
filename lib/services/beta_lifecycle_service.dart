...
class BetaLifecycleService {
  ...
  // QQL 242 Revision 0 recalculates the 30-day Beta lifetime from its own
  // release date, 20 September 2026, which lands on 20 October 2026 — the same
  // day as Build 241, because both were released on 20 September. This is the
  // policy applied afresh, not the previous expiry carried forward.
  static final DateTime expiryDate = DateTime(2026, 10, 20, 23, 59, 59);
