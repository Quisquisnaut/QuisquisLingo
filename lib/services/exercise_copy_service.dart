...
class ExerciseCopyService {
  ...
  static const _en = <String, String>{
    ...
    'instruction.build_translation': 'Build the translation from the word blocks.',
    'instruction.contextual_comprehension': 'Use the context to choose the correct answer.',
  };
  ...
  static const _es = <String, String>{
    ...
    'type.type_translation': 'ESCRIBE LA TRADUCCIÓN', 'type.build_translation': 'FORMA LA TRADUCCIÓN', 'type.contextual_comprehension': 'CONTEXTO',
    'instruction.type_translation': 'Escribe la traducción.', 'instruction.build_translation': 'Forma la traducción con los bloques de palabras.', 'instruction.contextual_comprehension': 'Usa el contexto para elegir la respuesta correcta.',
  };
  ...
  static const _it = <String, String>{
    ...
    'type.type_translation': 'SCRIVI LA TRADUZIONE', 'type.build_translation': 'COMPONI LA TRADUZIONE', 'type.contextual_comprehension': 'CONTESTO',
    'instruction.type_translation': 'Scrivi la traduzione.', 'instruction.build_translation': 'Componi la traduzione con i blocchi di parole.', 'instruction.contextual_comprehension': 'Usa il contesto per scegliere la risposta corretta.',
  };
